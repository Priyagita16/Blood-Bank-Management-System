...
Partial Class Form12
    ...
    Private Sub InitializeComponent()
        ...
        DataGridView1.Location = New Point(620, 214)
        DataGridView1.Name = "DataGridView1"
        DataGridView1.Size = New Size(224, 273)
        ...
        Label2.TabIndex = 68
        Label2.Text = "DONATION"
        ' 
        ' DataGridView2
        ' 
        DataGridView2.BackgroundColor = SystemColors.ButtonHighlight
        DataGridView2.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        DataGridView2.Location = New Point(259, 214)
        DataGridView2.Name = "DataGridView2"
        DataGridView2.Size = New Size(325, 273)
        ...
        Label3.Font = New Font("Georgia", 14.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label3.ForeColor = Color.Black
        Label3.Location = New Point(651, 188)
        Label3.Name = "Label3"
        Label3.Size = New Size(127, 23)
        Label3.TabIndex = 70
        Label3.Text = "Blood Stock"
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.BackColor = Color.Transparent
        Label4.Font = New Font("Georgia", 14.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label4.ForeColor = Color.Black
        Label4.Location = New Point(358, 188)
        Label4.Name = "Label4"
        Label4.Size = New Size(126, 23)
        Label4.TabIndex = 71
        Label4.Text = "Donors List"
        ' 
        ' Label5
        ' 
        Label5.AutoSize = True
        Label5.Location = New Point(463, 102)
        Label5.Name = "Label5"
        ...
        ' DNameTb
        ' 
        DNameTb.BackColor = SystemColors.GradientInactiveCaption
        DNameTb.Location = New Point(259, 120)
        DNameTb.Name = "DNameTb"
        DNameTb.Size = New Size(158, 23)
        DNameTb.TabIndex = 73
        ' 
        ' Label14
        ' 
        Label14.AutoSize = True
        Label14.Location = New Point(259, 102)
        ...
        ' DBGroupTb
        ' 
        DBGroupTb.BackColor = SystemColors.GradientInactiveCaption
        DBGroupTb.Location = New Point(463, 120)
        DBGroupTb.Name = "DBGroupTb"
        DBGroupTb.Size = New Size(91, 23)
        DBGroupTb.TabIndex = 75
        ' 
        ' Button1
        ' 
        Button1.BackColor = Color.Lime
        Button1.Font = New Font("Segoe UI Semibold", 11.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Button1.Location = New Point(611, 111)
