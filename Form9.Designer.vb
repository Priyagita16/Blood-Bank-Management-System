...
Partial Class Form9
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Location = New Point(433, 54)
        Label2.Name = "Label2"
        Label2.Size = New Size(221, 32)
        Label2.TabIndex = 35
        Label2.Text = "BLOOD TRANSFER"
        ' 
        ' Panel3
        ' 
        ...
        Label14.Font = New Font("Georgia", 14.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label14.ForeColor = Color.White
        Label14.Location = New Point(42, 161)
        Label14.Name = "Label14"
        Label14.Size = New Size(102, 23)
        Label14.TabIndex = 20
        Label14.Text = "Donation"
        ' 
        ' Panel10
        ' 
        Panel10.BackColor = Color.Firebrick
        Panel10.Location = New Point(26, 161)
        ...
        Panel8.Location = New Point(26, 115)
        Panel8.Name = "Panel8"
        ...
        Panel6.Location = New Point(26, 256)
        Panel6.Name = "Panel6"
        ...
        Label13.Location = New Point(42, 115)
        ...
        Label11.Location = New Point(42, 256)
        ...
        Label10.Location = New Point(42, 304)
        ...
        Label7.Location = New Point(42, 67)
        Label7.Name = "Label7"
        ...
        Panel9.Location = New Point(26, 67)
        Panel9.Name = "Panel9"
        ...
        Panel5.Location = New Point(26, 304)
        Panel5.Name = "Panel5"
        ...
        ' PIDCb
        ' 
        PIDCb.BackColor = SystemColors.GradientInactiveCaption
        PIDCb.FormattingEnabled = True
        PIDCb.Items.AddRange(New Object() {"MALE", "FEMALE", "OTHER"})
        PIDCb.Location = New Point(258, 165)
        PIDCb.Name = "PIDCb"
        PIDCb.Size = New Size(126, 23)
        PIDCb.TabIndex = 49
        ' 
        ' PNameTb
        ' 
        ...
        PNameTb.ForeColor = SystemColors.MenuText
        PNameTb.Location = New Point(448, 165)
        PNameTb.Name = "PNameTb"
        PNameTb.Size = New Size(183, 23)
        PNameTb.TabIndex = 48
        ' 
        ' Label15
        ' 
        Label15.AutoSize = True
        Label15.Location = New Point(448, 137)
        Label15.Name = "Label15"
        Label15.Size = New Size(90, 15)
        Label15.TabIndex = 47
        Label15.Text = "PATIENT NAME:"
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.Location = New Point(677, 137)
        Label4.Name = "Label4"
        ...
        ' PBGroupTb
        ' 
        PBGroupTb.BackColor = SystemColors.GradientInactiveCaption
        PBGroupTb.Enabled = False
        PBGroupTb.ForeColor = SystemColors.MenuText
        PBGroupTb.Location = New Point(677, 165)
        PBGroupTb.Name = "PBGroupTb"
        PBGroupTb.Size = New Size(138, 23)
        PBGroupTb.TabIndex = 45
        ' 
        ' Label3
        ' 
        Label3.AutoSize = True
        Label3.Location = New Point(258, 137)
        Label3.Name = "Label3"
        ...
        AvailableLbl.Font = New Font("Georgia", 14.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        AvailableLbl.ForeColor = Color.Red
        AvailableLbl.Location = New Point(456, 254)
        AvailableLbl.Name = "AvailableLbl"
        AvailableLbl.Size = New Size(163, 23)
        AvailableLbl.TabIndex = 50
        ...
        Button1.Location = New Point(446, 333)
        ...
        Label5.Font = New Font("Verdana", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label5.Location = New Point(858, 9)
        Label5.Name = "Label5"
    ...
    Friend WithEvents PIDCb As ComboBox
    Friend WithEvents PNameTb As TextBox
    Friend WithEvents PBGroupTb As TextBox
